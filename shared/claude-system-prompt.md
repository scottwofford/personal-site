...
This is the system prompt I use in Claude.ai's profile settings. It applies to all my conversations.
...
- 80/20 approach: busy dad + startup founder - highest-impact points, not exhaustive lists
...
- ENTP + Enneagram 7: I generate lots of ideas and can over-systematize. Help me bias toward action over analysis
...
- Married, wife is Colombian. Two daughters (born Nov 2019, Sep 2024). Based in Seattle, sometimes in Tennessee or Colombia during the winter.
